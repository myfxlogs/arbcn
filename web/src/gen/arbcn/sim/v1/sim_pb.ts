 ...
 *
 * @generated from message arbcn.sim.v1.GetPerformanceReportRequest
 */
export type GetPerformanceReportRequest = Message<"arbcn.sim.v1.GetPerformanceReportRequest"> & {
};

/**
 * Describes the message arbcn.sim.v1.GetPerformanceReportRequest.
 * Use `create(GetPerformanceReportRequestSchema)` to create a new message.
 */
export const GetPerformanceReportRequestSchema: GenMessage<GetPerformanceReportRequest> = /*@__PURE__*/
  messageDesc(file_arbcn_sim_v1_sim, 19);

/**
 * @generated from message arbcn.sim.v1.GetPerformanceReportResponse
 */
export type GetPerformanceReportResponse = Message<"arbcn.sim.v1.GetPerformanceReportResponse"> & {
  /**
   * 首尾快照天数（窗口未满 = 实际天数 < 30）
   *
  ...
  /**
   * TWR 时间加权年化 %（不可算 = 0 + status 说明）
   *
   * @generated from field: double twr_annualized = 2;
   */
   ...
   * MWR 资金加权年化 %（同上）
   *
   * @generated from field: double mwr_annualized = 3;
   */
  mwrAnnualized: number;

  /**
   * pass/watch/fail/env_no_window/pending/data_anomaly
   *
   ...
   * 判定门① 中文说明（含判据）
   *
   * @generated from field: string status_note = 5;
   */
  statusNote: string;
   ...
   * 诚实基线下限 %（3.2）
   *
   * @generated from field: double baseline_low = 6;
   */
  baselineLow: number;
   ...
   * 诚实基线上限 %（3.7）
   *
   * @generated from field: double baseline_high = 7;
   */
  baselineHigh: number;

  /**
   * 摩擦余量 %（0.3，D-046 业主核实普通主户）
   *
   * @generated from field: double friction_margin = 8;
   */
  frictionMargin: number;

  /**
   * 判定线 %（= baseline_high + friction_margin = 4.0）
   *
   * @generated from field: double gate_threshold = 9;
   */
  gateThreshold: number;

  /**
   * 窗口内 funding 中位数 %（环境条件；无数据 = 0）
   *
   * @generated from field: double funding_median = 10;
   */
  fundingMedian: number;

  /**
   * 窗口内 funding max %（无数据 = 0）
   *
   * @generated from field: double funding_max = 11;
   */
  fundingMax: number;

  /**
   * 窗口内 funding ≥ 15% 时段数（D-016 高费率窗口）
   *
   * @generated from field: int32 high_window_events = 12;
   */
  highWindowEvents: number;

  /**
   * 可交易面 = distinct (venue,symbol) 对（监控面内）
   *
   * @generated from field: int32 tradable_pairs = 13;
   */
  tradablePairs: number;

  /**
   * 窗口内成交单数（filled+closed；0 = 测环境非策略）
   *
   * @generated from field: int32 order_count = 14;
   */
  orderCount: number;
   ...
   * 窗口内拒单数（rejected 负样本）
   *
   * @generated from field: int32 rejected_count = 15;
   */
   ...
   * 窗口起点快照时刻
   *
   * @generated from field: int64 start_ts_ms = 16;
   */
  startTsMs: bigint;
   ...
   * 窗口末点快照时刻
   *
   * @generated from field: int64 end_ts_ms = 17;
   */
  endTsMs: bigint;

  /**
   * 窗口内实际 equity 快照数（D-063 可信度：判定数据面自证）
   *
   * @generated from field: int32 snapshot_count = 18;
   */
  snapshotCount: number;

  /**
   * 连续运行基线期望快照数（8h tick；30d→90）
   *
   * @generated from field: int32 expected_snapshots = 19;
   */
  expectedSnapshots: number;

  /**
   * 实际/期望覆盖率（0–1；<0.9 → 判定不采信）
   *
   * @generated from field: double snapshot_coverage = 20;
   */
  snapshotCoverage: number;
};

/**
 * Describes the message arbcn.sim.v1.GetPerformanceReportResponse.
 * Use `create(GetPerformanceReportResponseSchema)` to create a new message.
 */
export const GetPerformanceReportResponseSchema: GenMessage<GetPerformanceReportResponse> = /*@__PURE__*/
...
export const SimService: GenService<{
  ...
  /**
   * @generated from rpc arbcn.sim.v1.SimService.GetPerformanceReport
   */
