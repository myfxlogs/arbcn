...
//
//	go test -tags=live -run TestLivePoll -v ./internal/collect/exchange/
//
// 中国大陆直连 Binance/OKX 公开 API 可能被墙；失败时错误即证据（含端点 URL），
...
// TestLivePoll：对真实 Binance fapi / OKX v5 各拉取一轮，事实逐条打日志。
